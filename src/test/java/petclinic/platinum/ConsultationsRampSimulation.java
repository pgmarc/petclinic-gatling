...
public class ConsultationsRampSimulation extends Simulation {
    ...
    ScenarioBuilder consultationFeature = scenario("Platinum owners make consultations to vets [RAMP]")
    ...
    {
        setUp(consultationFeature.injectOpen(rampUsers(USERS).during(DURATION))).protocols(httpProtocol);
    }
